...
Vue.component('cart-header-component', require('./components/cart/CartHeaderComponent.vue').default);
Vue.component('show-product-component', require('./components/product/Show').default);
/**
